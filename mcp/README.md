...
무거운 인덱싱 없이 검색·조문·별표·인용검증을 실시간 조회한다(설계·근거는 [루트 README §3](https://github.com/sklim84/KFinLaw/blob/main/README.md#3-kfinlaw-with-mcp)).
...
- **플러그인:** 저장소에 [`.claude-plugin/marketplace.json`](https://github.com/sklim84/KFinLaw/blob/main/.claude-plugin/marketplace.json) + [`mcp/.claude-plugin/plugin.json`](https://github.com/sklim84/KFinLaw/blob/main/mcp/.claude-plugin/plugin.json) 동봉(MCP 서버는 `uvx --from ${CLAUDE_PLUGIN_ROOT} kfinlaw-mcp`로 기동).
