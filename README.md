...
|---|:-:|:-:|---|---|---|
| 하이브리드(BM25+KURE) 🏆 | ✓ | — | **0.860** | **0.775** | **0.793** |
| BM25 | ✓ | — | 0.848 | 0.765 | 0.781 |
| BM25 | — | — | 0.835 | 0.707 | 0.741 |
| 하이브리드(BM25+KURE) | — | — | 0.831 | 0.710 | 0.735 |
| 하이브리드(BM25+KURE) | ✓ | HyDE | 0.812 | 0.743 | 0.750 |
| 벡터(KURE) | ✓ | — | 0.808 | 0.748 | 0.751 |
| 벡터(KURE) | — | — | 0.767 | 0.656 | 0.672 |
| LightRAG (naive) | — | — | 0.738 | 0.639 | 0.648 |
| 벡터(KURE) | — | HyPE | 0.721 | 0.622 | 0.637 |
| LightRAG (mix) | — | — | 0.665 | 0.606 | 0.616 |
| 벡터(KURE) | — | HyDE | 0.652 | 0.558 | 0.572 |
