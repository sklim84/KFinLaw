...
**반직관적 발견 — 구어체 ≥ 격식체.** 구어체 질문이 격식체보다 검색이 더 쉬웠다(벡터 KURE 격식 0.733 vs 구어 1.000, 그림 7). 메울 질의–조문 어휘격차가 애초에 작다는 뜻이며, 이것이 가설질문·가설답변(HyPE·HyDE) 증강이 효과 없던 이유를 설명한다 — "정교한 기법 ≠ 더 나음, 도입 전 실측". 적용 시 권고는 [한눈에](#한눈에) 요약을 참고.

<img src="benchmark/figures/fig_07_register.png" width="460" alt="격식체 vs 구어체">

> **그림 7.** 구어체 ≥ 격식체 — 질의측 어휘격차가 작아 HyPE·HyDE 증강이 무의미함을 예측.
