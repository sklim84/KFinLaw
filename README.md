...
핵심 검색 구성을 **세 벤치마크 × 3개 메트릭(recall@5 · MRR · nDCG@10)** 으로 평가했다(평균 recall@5 순). 청킹은 조(條) 단위, 임베딩은 KURE-v1 고정, 리랭커는 4종 비교. 증강(HyDE·HyPE·LightRAG)은 전부 baseline 미달이라 [§3.1.2](#312-실험별-결과)에 따로 둔다.

| 구성 | **Lexical**<br>R@5 | MRR | nDCG | **Semantic**<br>R@5 | MRR | nDCG | **Locator**<br>R@5 | MRR | nDCG | 평균<br>R@5 |
|---|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| 하이브리드+리랭커(bge-reranker-v2-m3) 🏆 | 0.860 | 0.775 | 0.793 | 0.756 | 0.661 | 0.684 | 0.660 | 0.786 | 0.703 | **0.759** |
| 하이브리드+리랭커(ko-reranker) | 0.838 | 0.729 | 0.754 | 0.769 | 0.672 | 0.691 | 0.669 | 0.833 | 0.728 | **0.758** |
| 하이브리드+리랭커(ko-reranker-8k) | 0.863 | 0.785 | 0.804 | 0.708 | 0.608 | 0.637 | 0.677 | 0.847 | 0.749 | **0.749** |
| 벡터(KURE)+리랭커 | 0.808 | 0.748 | 0.751 | 0.777 | 0.661 | 0.684 | 0.626 | 0.759 | 0.700 | **0.737** |
| 하이브리드+리랭커(bge-reranker-large) | 0.798 | 0.699 | 0.719 | 0.729 | 0.621 | 0.644 | 0.666 | 0.812 | 0.716 | **0.731** |
| 하이브리드(BM25+KURE) | 0.831 | 0.710 | 0.735 | 0.658 | 0.562 | 0.588 | 0.443 | 0.515 | 0.449 | **0.644** |
| 벡터(KURE) | 0.767 | 0.656 | 0.672 | 0.767 | 0.612 | 0.648 | 0.376 | 0.439 | 0.402 | **0.636** |
| BM25 | 0.835 | 0.707 | 0.741 | 0.510 | 0.397 | 0.430 | 0.197 | 0.259 | 0.198 | **0.514** |
