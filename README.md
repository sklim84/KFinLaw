...
전체 240문 기준. 공통 조건은 **조(條) 단위 청킹**이며, 하이브리드 = BM25+KURE(RRF) · dense 임베딩 = KURE-v1 · 리랭커 = bge-reranker-v2-m3. (검색기·리랭커·증강만 바꿔 비교)

| 검색기 | 리랭커 | 증강 | recall@5 | MRR | nDCG@10 |
|---|:-:|:-:|---|---|---|
| 하이브리드 🏆 | ✓ | — | **0.860** | **0.775** | **0.793** |
| BM25 | ✓ | — | 0.848 | 0.765 | 0.781 |
| BM25 | — | — | 0.835 | 0.707 | 0.741 |
| 하이브리드 | — | — | 0.831 | 0.710 | 0.735 |
| 하이브리드 | ✓ | HyDE | 0.812 | 0.743 | 0.750 |
